...
#' @param pt.color Point color for average estimated effect of dummy independent variable, default is 'red'.
#' @param pt.size  Point size for average estimated effect of dummy independent variable, default is 1.5.
...
effect <- function(model,var,level=0.95,dummyIV=F,
                   ...
                   pt.color='red',pt.size=1.5,pt.type=16,
                   plot.title=NULL) {
